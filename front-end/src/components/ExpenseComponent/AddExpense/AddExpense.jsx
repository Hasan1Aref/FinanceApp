...
export default function AddExpense(props) {
    return (
        <div className='HA_AddExpense'>
            ...
            <button className="HA_input" type='button' onClick={props.toggleaddExpensesModal}
            >Add</button>
            <button className="HA_input" type='button'>Search</button>
            </div>
            <Modal
                isOpen={props.addExpensesModal}
                toggle={props.toggleaddExpensesModal}
            >
                <ModalHeader toggle={props.toggleaddExpensesModal} >
                ...
                <ModalBody>
                    <FormGroup>
                        ...
                        <Input
                            ...
                            onChange={props.onChangeAddExpenseHandler}
                        />
                    </FormGroup>
              ...
              onChange={()=>{
                if(document.getElementById('recurring').value==1){
                  {props.ExpensesData.recurring='weakly'}
                  console.log('recurring if the value is weakly : '+props.ExpensesData.recurring)
            ...
            >
              ...
              <option value={2}>Recurring</option>
                ...
                <ModalFooter>
                    ...
                    <Button color="secondary" onClick={props.toggleaddExpensesModal}>
                        Cancel
                    </Button>
                </ModalFooter>
            </Modal>
